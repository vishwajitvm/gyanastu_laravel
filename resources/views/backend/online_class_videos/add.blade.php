            ...
            <!-- Basic Forms -->
             <div class="box">
               <div class="box-header with-border">
                 <h4 class="box-title">Add Videos for courses</h4>
               ...
               <div class="box-body">
                 <div class="row">
                   <div class="col">
                            ...
                            @endif
                            <!--error handling-->
                       <form novalidate method="POST" action=" {{Route('admin-online-videos.store')}}" enctype="multipart/form-data"> <!--form-->
                        @csrf
                         <div class="row">
                           <div class="col-12">	
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12"><!--col-6 stared here-->
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="lecture_topics"   class="form-control" required />
                                        </div>
                                    </div>
                                </div><!--col-6 Ended here-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select name="mode_of_upload" id="select"  class="form-control" onchange="classModeChecker(this);">
                                                ...
                                                <option value="pdf">Class Pdf</option>
                                            </select>
                                        </div>
                                    </div>
                                </div><!--col-6 Ended here-->
                            ...
                            <div class="row" id="video_upload_data" style="display: none">
                                <div class="col-md-12"><!--col-6 stared here-->
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="file" name="leactures_videos[]" multiple  class="form-control" accept="video/mp4,video/x-m4v,video/*" >
                                        </div>
                                    </div>
                                </div><!--col-6 Ended here-->
                            </div>
                            ...
                            <div class="row" id="video_urls_data" style="display: none">
                                <div class="col-md-12"><!--col-6 stared here-->
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="url" name="lecture_url"  class="form-control" placeholder="Http://" aria-invalid="false"> </div>
                                    </div>
                                </div><!--col-6 Ended here-->
                            </div>
                            ...
                            <div class="row" id="upload_lecture_data" style="display: none">
                                <div class="col-md-12"><!--col-6 stared here-->
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="file" name="study_materials[]" multiple  class="form-control" accept="application/pdf,application/vnd.ms-excel" >
                                        </div>
                                    </div>
                                </div><!--col-6 Ended here-->
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6"><!--col-6 stared here-->
                                    <div class="form-group">
                                        <h5>Todays Date</h5>
                                        <div class="controls">
                                            <input type="date" name="video_uploaded_date"  class="form-control"  aria-invalid="false"> </div>
                                    </div>
                                </div><!--col-6 Ended here-->
                                ...
                                <div class="col-md-6"><!--col-6 stared here-->
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="date" name="video_availabel_upto_date"  class="form-control"  aria-invalid="false"> </div>
                                    </div>
                                </div><!--col-6 Ended here-->
                            </div>
